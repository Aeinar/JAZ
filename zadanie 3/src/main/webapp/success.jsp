...
<body>
	...
	<li>Wniosek:<%= loanApplication.getNumber()
		+ " Osoba: " + loanApplication.getPerson().getSurname() + " " + loanApplication.getPerson().getFirstName()
		+ " Kwota: " + loanApplication.getParameters().getAmount()
		+ " liczba rat " + loanApplication.getParameters().getInstallmentCount()
		+ " Adres: " + loanApplication.getAddress().getCity()
		...
		+ ", nr lokalu " + loanApplication.getAddress().getLocalNumber()
		%> </li>
	<%
	}
	%>	
